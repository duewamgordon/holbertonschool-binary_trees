 ...
 *
 * Description:
 * This function traverses the binary tree in post-order and applies the provided
 * function to each node's value. It starts by recursively traversing the left
